...
for row_submatrix_C in range(submatrix_length//2 + submatrix_length % 2):                 # Цикл перебора строк до середины
    ...
    while column_submatrix_C > submatrix_length - 1 - row_submatrix_C:                    # Перебираем числа в строке, до главной диагонали
...
if counter_numbers_greater_than_K > multiplication_of_numbers:
    ...
    for row_submatrix_B in range(submatrix_length // 2 + submatrix_length % 2):                         # перебор строк
        ...
        while right_column_submatrix_B > submatrix_length - 1 - row_submatrix_B:                        # перебор чисел в строке до главной диагонали (для включения диагонали замените > на >=)
...
for row_matrix_F in range(submatrix_length):
    ...
    right_column_matrix_F = submatrix_length - 1
